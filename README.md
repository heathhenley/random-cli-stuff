...
but I want to keep the files on my local drive for easier access and don't want to rely on the Drive App / use offline mode. This is just a wrapper around `shutil.copytree`, yes I know about robocopy - was using this to have more control though.